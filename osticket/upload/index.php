...
**********************************************************************/
//Mudei essa validacao para cima, por conta de erro em  require('client.inc.php'); ser carregado antes
                ...
                <?php if ($cfg && $cfg->isKnowledgebaseEnabled()) { ?>
                    <form method="get" action="kb/faq.php" class="search-form">
                        <div class="input-group">
                            ...
                            <input type="text" name="q" class="search form-control" placeholder="Pesquise pela sua dúvida"/>
