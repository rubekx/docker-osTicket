...
class Validator
{
    ...
    public function validate($source, $userinput = true)
    {
        $this->errors = array();
    ...
    public static function is_email($email, $list = false, $verify = false)
    {
    ...
    public static function is_username($username, &$error = '')
    {
    ...
    public function process($fields, $vars, &$errors)
    {
