...
?>
	...
	'Use the forms below to create or update the information we have on file for your account'
            ...
            <p>Use os formulários abaixo para criar sua conta</p>
        </div>
    </div>
    <form class="form-group" action="account.php" method="post">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <input class="form-control" type="password" size="18" name="passwd1"
                       value="<?php echo $info['passwd1']; ?>">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <input class="form-control" type="password" size="18" name="passwd2"
                       value="<?php echo $info['passwd2']; ?>">
    ...
    <?php } ?>
        ...
        <p>
            ...
            <input class="btn btn-default" type="button" value="Cancelar" onclick="javascript:
