...
<head>
    ...
    <link rel="stylesheet" href="<?php echo ASSETS_PATH; ?>css/bootstrap.min.css" media="screen">
    ...
    <link type="text/css" rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/style_dinte.css">
			...
			<div class="container-fluid">
				<div class="navbar-header">
				  <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#myNavbar">
                    ...
                    <a class="navbar-left" href="<?php echo ROOT_PATH; ?>view.php" title="<?php echo __('Support Center'); ?>">
				...
				if($nav && ($navs=$nav->getNavLinks()) && is_array($navs)){
					...
					foreach($navs as $name =>$nav) {
						...
						}else if((!$thisclient || !$thisclient->isValid())){ // quado nao estiver logado
				   ...
				   <?php if ($thisclient && is_object($thisclient) && $thisclient->isValid()
									...
									<?php } elseif($nav) {
										...
										if ($thisclient && $thisclient->isValid() && $thisclient->isGuest()) { ?>
											<li><a href="<?php echo $signout_url; ?>">
                                                <span class="glyphicon glyphicon-log-out" ></span> Sair
											 <?php /*echo __('Sign Out'); */?></a></li><?php
										} elseif ($cfg->getClientRegistrationMode() != 'disabled') { ?>
											<li><a href="<?php echo $signin_url; ?>">
											 <span class="glyphicon glyphicon-log-in white"></span> Entrar
											 <?php /*echo __('Sign In'); */?></a></li>
										<?php }
									} ?>
					<?php
