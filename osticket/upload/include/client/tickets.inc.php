...
<div class="row ">
    <div class="col-md-6">
        ...
        <div class="input-group">
            ...
            <input class="search form-control" type="search" name="keywords" size="30"
                   value="<?php echo Format::htmlchars($settings['keywords']); ?>" placeholder="Pesquisar Tickets">
        ...
        <div>
            <?php if ($settings['keywords'] || $settings['topic_id'] || $_REQUEST['sort']) { ?>
                <div style="margin-top:10px"><strong><a href="?clear" style="color:#777"><i
                                    class="icon-remove-circle"></i> <?php echo __('Clear all filters and sort'); ?>
                        </a></strong></div>
            <?php } ?>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <h2>
            <a href="<?php echo Format::htmlchars($_SERVER['REQUEST_URI']); ?>">
                <i class="refresh icon-refresh"></i> Atualizar
                <?php /*echo __('Tickets'); */?>
            </a>
        </h2>
    </div>
            ...
            if ($tickets->exists(true)) {
                foreach ($tickets as $T) {
                    ...
                    <tr id="<?php echo $T['ticket_id']; ?>">
                        ...
                        <td data-title="Created" class="text-nowrap">
                            &nbsp;<?php echo Format::date($T['created']); ?></td>
                        <td data-title="Status" class="text-nowrap">&nbsp;<?php echo $status; ?></td>
                        <td data-title="Subject">
                            <div style="max-height: 1.2em; max-width: 320px;" class="link truncate"
                                 href="tickets.php?id=<?php echo $T['ticket_id']; ?>"><?php echo mb_strimwidth($subject, 0, 40, "..."); ?></div>
                        </td>
