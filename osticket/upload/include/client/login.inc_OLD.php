	...
	<div class="login-box col-md-6">
		...
		<div>
			...
			<label for="username">Email:
				<input class="form-control"  id="username" placeholder="Email" type="text" name="luser" size="39" value="<?php echo $email; ?>">
			</label>
		</div>
		<div>
		...
		<div>
			<p>
				...
				<a style="padding-top:4px;display:inline-block;" href="pwreset.php"><?php echo __('Esqueci minha senha'); ?></a>
				<?php } ?>
			</p>
		</div>
...
<?php }
    ...
    <a href="<?php echo ROOT_PATH; ?>scp/"><?php echo 'Fazer Login'; ?></a>
    </div>
    </div>
